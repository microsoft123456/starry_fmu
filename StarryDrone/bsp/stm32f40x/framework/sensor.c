...
{
	return rt_device_read(baro_device_t, RAW_TEMPERATURE_POS, (void*)raw, 32);
}

rt_err_t sensor_baro_read_raw_press(uint32_t* raw)
{
	return rt_device_read(baro_device_t, RAW_PRESSURE_POS, (void*)raw, 32);
}

rt_err_t sensor_baro_read_temperature(int32_t* temp)
{
	return rt_device_read(baro_device_t, COMPENSATE_TEMPERATURE_POS, (void*)temp, 32);
}

rt_err_t sensor_baro_read_pressure(int32_t* pressure)
{
	return rt_device_read(baro_device_t, COMPENSATE_PRESSURE_POS, (void*)pressure, 32);
}
