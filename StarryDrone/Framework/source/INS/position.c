...
//				Log.w(TAG, "L:%.3f	%.3f\n", ekf.x.element[0][0],ekf.z.element[0][0]);
//				Log.w(TAG, "l:%.3f	%.3f\n", ekf.x.element[1][0],ekf.z.element[1][0]);
//				Log.w(TAG, "h:%.3f	%.3f\n", ekf.x.element[2][0],ekf.z.element[2][0]);
//				Log.w(TAG, "vn:%.3f	%.3f\n", ekf.x.element[3][0],ekf.z.element[3][0]);
//				Log.w(TAG, "ve:%.3f	%.3f\n", ekf.x.element[4][0],ekf.z.element[4][0]);
//				Log.w(TAG, "vd:%.3f	%.3f\n", ekf.x.element[5][0],ekf.z.element[5][0]);

				calc_v = calc_v*0.8f+(pre_alt-ekf.x.element[0][0])/ekf.T*0.2f;
				//calc_v = (ekf.x.element[0][0]-pre_alt)/ekf.T;

				ekf.u.element[0][0] = 0.0f;
				ekf.u.element[1][0] = filter_acc;
...
//				Log.w(TAG, "%f	%f	%f	%f	%f	%f\n", ekf.x.element[0][0],baro_report.altitude,ekf.x.element[1][0],calc_v,
//					accE[2],filter_acc);
