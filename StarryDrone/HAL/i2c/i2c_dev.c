...
struct rt_i2c_bus_device rt_i2c1 , rt_i2c2;
...
rt_err_t i2c_bus_device_init(rt_device_t dev)
{
	...
	i2c_dev = *(BSP_I2C_Def*)dev->user_data;
...
rt_err_t device_i2c_init(char* name)
{
	...
	if(!strcmp(name, "i2c1"))
	{
		...
		stm32_i2c_bit_ops.data = (void*)&i2c1_def;
		rt_i2c1.priv = (void *)&stm32_i2c_bit_ops;
		rt_i2c1.retries = 3;
	...
	else if(!strcmp(name, "i2c2"))
	{
		...
		stm32_i2c_bit_ops.data = (void*)&i2c2_def;
		rt_i2c2.priv = (void *)&stm32_i2c_bit_ops;
		rt_i2c2.retries = 3;
